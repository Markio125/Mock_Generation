...
class TextProcessor:
    ...
    def split_into_sections(text):
        ...
        words = text.split()
        num_sections = len(words) // 1000   #each section will contain roughly 1000 words
...
# Example Usage
pdf_file = "pdf_storage/sample.pdf"  # Replace with file path
json_file = "business_studies.json"
chapter_name = "Introduction to AI"  # chapter name
