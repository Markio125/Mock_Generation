...
class DistributionAgent:
    ...
    @staticmethod
    def question_distribution_manual() -> Dict:
        logger.info("Setting question distribution across topics")
        with open("utils/business_studies_distribution.json", "r", encoding="utf-8") as json_file:
...
text = test.question_distribution_manual()
print(text)
